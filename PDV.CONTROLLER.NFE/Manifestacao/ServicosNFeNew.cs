...
{
    public sealed class ServicosNFeNew : IDisposable
    {
        ...
        public ServicosNFeNew(ConfiguracaoServico cFgServico, X509Certificate2 certificado = null)
        {
        ...
        public RetornoNfeDistDFeInt NfeDistDFeInteresse(string ufAutor, string documento, string ultNSU = "0", string nSU = "0", string chNFE = "")
        {
            ...
            var xmlConsulta = pedDistDFeInt.ObterXmlStringNew();
            ValidadorNew.Valida(ServicoNFe.NFeDistribuicaoDFe, _cFgServico.VersaoNFeDistribuicaoDFe, xmlConsulta, cfgServico: _cFgServico);
            var dadosConsulta = new XmlDocument();
            dadosConsulta.LoadXml(xmlConsulta);
