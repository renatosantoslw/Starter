...
{
    public static class ExtdistDFeIntNew
    {
        ...
        public static string ObterXmlStringNew(this distDFeInt pedDistDFeInt)
        {
            return FuncoesXmlNew.ClasseParaXmlString(pedDistDFeInt);
        }
    }
}
