...
{
    public partial class Baixarecebimento
    {
        public Baixarecebimento()
        {
            Chequecontarecebers = new HashSet<Chequecontareceber>();
        }
        ...
        public virtual ICollection<Chequecontareceber> Chequecontarecebers { get; set; }
    }
}
