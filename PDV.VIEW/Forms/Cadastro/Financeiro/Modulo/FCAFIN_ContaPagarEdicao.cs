    ...
    public partial class FCAFIN_ContaPagarEdicao : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void SalvarTudo()
        {
            try
            {
                ...
                /*
                MessageBox.Show("1",ovTXT_Emissao.Text);
                MessageBox.Show("2", ovTXT_Vencimento.Text);
                MessageBox.Show("3", ovTXT_Fluxo.Text);
                MessageBox.Show("4", ovTXT_Emissao.Value.Date.ToString());
                MessageBox.Show("5", ovTXT_Vencimento.Value.Date.ToString());
                MessageBox.Show("6", ovTXT_Fluxo.Value.Date.ToString());
                */               
