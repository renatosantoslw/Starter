...
namespace PDV.VIEW.Forms.Gerenciamento.DAV
{
    public partial class LoginAdminDAV : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void Logar()
        {
            ...
            if (Logado != null)
            {
                if (!IsAdmin())
                {
                    ...
                    MensageErro("Usuário não é Administrador.");
                }
                else
                {
            ...
            else
            {
                ...
                if (Logado == null)
                {
                    ...
                    MensageErro("Email ou Senha Incorreto.");
                    Logado = null;
                    return;
                }
                else
        ...
        public void MensageErro(string texto)
        {
        ...
        private void LoginAdminDAV_Load(object sender, EventArgs e)
        {
